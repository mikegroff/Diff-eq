...
f = @(t,x) (1/t + 1/t^2)*x; %x'(t) of approximation of problem 12
k = 0.47047;
g = @(t,x) (2*t + k/(1+k*t))*(1-x); %x'(t) of approximation of problem 13
h = @(t,x) 1/t*(cos(t) - x); %x'(t) of of approximation of problem 15

hh = 0.01; x0 = -1/exp(1); x1 = 1-(0.3084284*(1/(1+k))-0.0849713*(1/(1+k))^2+0.6627698*(1/(1+k))^2)*2/(sqrt(pi)); x2 = sin(1);
